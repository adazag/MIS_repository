...
CREATE VIEW [data_out_ad].[v_LEAP_ProjectTimesheet] as
...
GRANT SELECT
    ON OBJECT::[data_out_ad].[v_LEAP_ProjectTimesheet] TO [data_out_ad_alter_all]
    AS [dbo];
GO

GRANT SELECT
    ON OBJECT::[data_out_ad].[v_LEAP_ProjectTimesheet] TO [data_out_ad_read_all]
    AS [dbo];
GO
