...
CREATE view [data_mis_project].[fc_tracked_time_new] as
...
GRANT SELECT
    ON OBJECT::[data_mis_project].[fc_tracked_time_new] TO [Pricing_data_read]
    AS [dbo];
GO

GRANT SELECT
    ON OBJECT::[data_mis_project].[fc_tracked_time_new] TO [data_mis_project_fc_tracked_time_new_read_all]
    AS [dbo];
GO
