...
CREATE VIEW [data_mis_project].[tmsht_pm_approval_daily] as
with TIMESHEETS as (
SELECT [client_id]
      ,[client_name]
      ,[project_id]
 ...
 --     ,[comment]
  ...
  and timeoff = 0 and day_date >= '2025-01-01'
),
...
select * from tmst_pm_approver  -- where employee_id = 149743 and week_number = 'W17' and month_date = '2025-04'
GO
