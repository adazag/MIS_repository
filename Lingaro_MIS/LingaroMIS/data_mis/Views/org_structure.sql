...
CREATE   VIEW [data_mis].[org_structure] AS 
...
select *
from org_unit
where type='OH' and parent_id is null
),
------------------------------
...
select *
from org_unit
where type='BU' or type='CoE'   or ( type='OH'  and parent_id=15)
),
...
Total as (select 
ORG_ID as org_unit_id
,ORG_NAME as org_unit_name
,type as TYPE
,leader_id as LEADER_ID
,T_ID as Level5
,T_NAME as Level5Name
,DT_ID as Level4
,DT_NAME as Level4Name
,SDT_ID as Level3
,SDT_NAME as Level3Name
,SBU_ID as     Level2
,SBU_NAME as     Level2Name
,BU_ID as Level1
,BU_NAME as Level1Name
,OH_ID as Level0
,OH_NAME as Level0Name
...
FROM
    Total oh
LEFT JOIN
    data_in.org_unit u ON oh.org_unit_id = u.id
	--where org_unit_id=630
--ORDER BY
--    oh.id;
GO
